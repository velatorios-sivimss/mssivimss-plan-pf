...
import com.imss.sivimss.planpf.model.request.*;
import com.imss.sivimss.planpf.model.response.BusquedaInformacionReporteResponse;
import com.imss.sivimss.planpf.service.impl.ContratarPlanPFServiceImpl;
...
public class ConvenioNuevoPF {
    ...
    public DatosRequest insertarConvenioPfPersona(PersonaRequest personaRequest, String usuario) {
        Integer numeroBeneficiarios = personaRequest.getPersona().getBeneficiarios().length;
